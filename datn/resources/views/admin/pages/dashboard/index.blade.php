                ...
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body pb-2">
                            <div
                                class="d-flex justify-content-around align-items-center flex-wrap mb-4"
                            >
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-12 mb-4">
                            <div class="card">
                                <div
                                    class="card-header d-flex justify-content-between pb-3"
                                >
                        ...
                        >
                            <div class="d-flex align-items-center me-3">
                                ...
                                <div class="card-title mb-0">
                                    ...
                                    >Awesome App for Project Management</small
                                    >
                                </div>
                            </div>
                ...
                <div class="col-md-5 col-lg-5 mb-0">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="timeline">
                                <li
                                    class="timeline-item timeline-item-transparent ps-4"
                                >
                          <span
